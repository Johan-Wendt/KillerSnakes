package rest;
	...
	public enum Happenings implements HappeningDetails {
		SPPED(1, 0.005, 35, 40, "M0,0 L0,40 35,40 35,0 Z"), GROW(2, 0.005, 30, 40, "M0,0 L0,40 30,40 30,0 Z"), PISTOL(3, 0.002, 31, 40, "M0,0 L0,40 31,40 31,0 Z"), SHOTGUN(4, 0.001, 40 , 22, "M0,0 L0,22 40,22 40,0 Z");
